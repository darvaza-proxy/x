...
// multiply whose product overflows the native width and so proves the
// wider MulDivMod intermediate.
...
var (
	_ core.TestCase = signedDivModCase[num.Int32]{}
	_ core.TestCase = signedMulDivModCase[num.Int32]{}
	_ core.TestCase = signedUnaryCase[num.Int32]{}
	_ core.TestCase = signedCmpCase[num.Int32]{}
)
