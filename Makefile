...
GOLANGCI_LINT_VERSION ?= $(shell $(TOOLSDIR)/get_version.sh 1.25 v2.11.4 v2.11.4 v2.13.1)
REVIVE_VERSION ?= $(shell $(TOOLSDIR)/get_version.sh 1.25 v1.15.0 v1.15.0 v1.16.0)
